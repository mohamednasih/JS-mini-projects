...
const textTospeechKey='5f80244568814caf83e077968211df27'

//Tell me a joke button
const tellMeAjoke=document.getElementById("tellMeAjoke")
...
tellMeAjoke.addEventListener("click",()=>{
    tellMeAjoke.hidden=true;
    getjoke().then((joke)=>{
        ...
        setTimeout(()=>tellMeAjoke.hidden=false,2*1000)
